...
<html lang="en">
    ...
    <body>
        <div class="limiter">
            <div class="container-login100" style="background-image: url('images/login-background.jpg');">
                <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
                    <form class="login100-form validate-form flex-sb flex-w" action="validate.jsp" method="POST">
                        ...
                        <a href="https://www.google.com/" class="btn-google m-b-20">
                        ...
                        <div class="alert-warningp-t-13 p-b-9" >
